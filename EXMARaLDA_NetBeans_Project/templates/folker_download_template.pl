	...
	if ($language eq "de"){
		...
		print qq|
			<div id="inhalt">
				...
				<p>
                                    <i><font size="-1">Diese Version stammt vom @DATE@. Alle &Auml;nderungen zu den Vorg&auml;ngerversionen sind 
		...
		print qq|
			<div id="inhalt">
				...
				<p><i><font size="-1">This version is from @DATE@. All changes with respect to previous versions are described <a href="http://agd.ids-mannheim.de/folker_changes.html">on this page</a>.</font></i></p>
				<hr/>
