...
# OTHER STUFF
CP_JAVA_6=$WORKINGDIR/lib/commons-logging-1.2.jar:$WORKINGDIR/lib/swing-worker-1.2.jar:$WORKINGDIR/lib/commons-lang-2.5.jar:$WORKINGDIR/lib/commons-io-2.4.jar:$WORKINGDIR/lib/bounce.jar:$WORKINGDIR/lib/cobra.jar:$WORKINGDIR/lib/jcalendar-1.4.jar
