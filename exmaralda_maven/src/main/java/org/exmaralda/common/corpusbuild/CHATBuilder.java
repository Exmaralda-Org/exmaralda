...
public class CHATBuilder {
    ...
    File resultFile;
    Vector<File> chatFiles;
    Hashtable<String,File[]> communicationsWithExmaraldaFiles = new Hashtable<String, File[]>();
    Hashtable<String,File> communicationsWithCHATFiles = new Hashtable<String, File>();
    ...
    public CHATBuilder(File resultFile, Vector<File> chatFiles, String directory, boolean separateDirectory, boolean writeBasic) throws IOException {
