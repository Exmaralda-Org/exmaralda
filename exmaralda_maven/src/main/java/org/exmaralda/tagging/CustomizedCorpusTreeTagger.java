...
public class CustomizedCorpusTreeTagger extends COMACorpusWalker {
    ...
    public CustomizedCorpusTreeTagger(File corpusFile, TreeTagger tt, String sxp, String txp, boolean wsf, boolean i, String s) throws IOException, JDOMException {
        super();
    ...
    public static void main(String[] args){
        try {
            ...
            CustomizedCorpusTreeTagger ctt = new CustomizedCorpusTreeTagger(corpusFile,tt,segmentationXPath,tokenXPath,true, true, "_POS");
            ctt.tagCorpus();
        } catch (IOException ex) {
            Logger.getLogger(CustomizedCorpusTreeTagger.class.getName()).log(Level.SEVERE, null, ex);
