...
public class BrownNoiseGeneratorOld {
...
*/
public BrownNoiseGeneratorOld (double minValue, double maxValue) {
...
*/
public BrownNoiseGeneratorOld (double minValue, double maxValue, double slope, double hpFilter) {
...
} // end class BrownNoiseGeneratorOld