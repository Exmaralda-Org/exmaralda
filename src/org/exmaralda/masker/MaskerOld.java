...
public class MaskerOld {
    ...
    BrownNoiseGeneratorOld brownNoiseGenerator = new BrownNoiseGeneratorOld(-0.4,0.4);   
    ...
    public MaskerOld(File fileIn, File fileOut) throws IOException, WavFileException, URISyntaxException, ClassNotFoundException {
