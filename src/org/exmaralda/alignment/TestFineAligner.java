...
public class TestFineAligner {
    ...
    private void doit() throws SAXException, JexmaraldaException, IOException, JDOMException, FSMException {
        BasicTranscription bt = new BasicTranscription("F:\\AGD-DATA\\dgd2_data\\exb-transcripts\\ISW\\ISW-_E_00004_SE_01_T_03_DF_01.exb");
        bt.getHead().getMetaInformation().setReferencedFile("Y:\\media\\audio\\ISW\\ISW-_E_00004_SE_01_A_01_DF_01.WAV");
