        ...
        <html>
            ...
            <body>
                ...
                <table>
                    ...
                    <tr class="odd">
                        <th class="category">Contributions (number)</th>
                        <xsl:for-each select="//speaker">                            
                            <td>
                    ...
                    <tr class="odd">
                        <th class="category">Words (tokens)</th>
                        <xsl:for-each select="//speaker">
                            <td>
                                <xsl:attribute name="class">
                                    <xsl:if test="position() mod 2 =0">even</xsl:if>
                    ...
                    <tr class="even">
                        <th class="category">Words (types)</th>
                        <xsl:for-each select="//speaker">
                    ...
                    <tr class="odd">
                        <th class="category">Micro pauses</th>
                        <xsl:for-each select="//speaker">
                            <td>
                    ...
                    <tr class="even">
                        <th class="category">Non-phonological</th>
                        <xsl:for-each select="//speaker">
                            <td>
                    ...
                    <tr class="odd">
                        <th class="category">Breathing</th>
                        <xsl:for-each select="//speaker">
                            <td>
                    ...
                    <tr class="even">
                        <th class="category">Measured pauses (number)</th>
                        <xsl:for-each select="//speaker">                            
                            <td>
                ...
                <p style="border:1px gray solid; margin-top:10px;">                        
                    ...
                    </span> total transcribed time.
                    <span class="count">
                        <xsl:value-of select="count(//contribution)"/>
                    </span> contributions, of which
                    <span class="count"><xsl:value-of select="count(//contribution[@parse-level='1'])"/></span> with syntax errors and
                    <span class="count"><xsl:value-of select="count(//contribution[@parse-level='0'])"/></span> with time errors.
                </p>                
            </body>
        </html>
    </xsl:template>
