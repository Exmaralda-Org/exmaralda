...
public class EditPreferencesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        alphabetComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Default", "German (Deutsch)", "German (Deutsch) + Capitals", "English", "French (Français)", "Portuguese (Portugu?s)", "Hungarian (Magyar)", "Turkish (Türkçe)", "Danish (Dansk)", "Spanish (Espagnol)", "Italian (Italiano)", "Czech (èetina)", "Russian (Latin transliteration)", "Universal" }));
