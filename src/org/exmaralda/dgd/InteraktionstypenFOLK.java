 ...
 * @author Schmidt
 */
public class InteraktionstypenFOLK {
    ...
    public InteraktionstypenFOLK(String directory) {
    ...
    void doit() throws JDOMException, IOException{
        ...
        for (File f : files){
            ...
            try {
                ...
                addElement("//Sprechereignis[1]/Basisdaten/Art", xmlDoc, cre);
                addElement("/Ereignis/Basisdaten[1]/Ort[1]/Region[1]", xmlDoc, cre);
    ...
    static String INPUT_DIRECTORY = "O:\\xml\\events\\final\\FOLK";
    static String OUTPUT_FILE = "C:\\Users\\Schmidt\\Dropbox\\FOLK-DGD\\Werkvertrag_Timm\\Interaktions_Typen.xml";
    ...
    public static void main(String[] args) {
        try {
            InteraktionstypenFOLK tabulator = new InteraktionstypenFOLK(INPUT_DIRECTORY);
            tabulator.doit();
            tabulator.writeResultList(OUTPUT_FILE);
        } catch (SAXException ex) {
            Logger.getLogger(InteraktionstypenFOLK.class.getName()).log(Level.SEVERE, null, ex);
