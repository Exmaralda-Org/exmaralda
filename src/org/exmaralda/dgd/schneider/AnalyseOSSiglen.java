 ...
 * @author Schmidt
 */
public class AnalyseOSSiglen extends AbstractSchneiderProcessor {
    
    File metaDirectory;
    
    
    public AnalyseOSSiglen(String[] args){
    ...
    public static void main(String[] args) {
        try {
            String[] myArgs = {
                "Y:\\thomas\\OS2FLK\\11", "fln", 
                "X:\\xml\\events\\Werkstatt\\OS"
            };
            AnalyseOSSiglen aa = new AnalyseOSSiglen(myArgs);
            aa.processFiles();
            System.exit(0);
        } catch (Exception ex) {
    ...
    private void processFiles() throws JDOMException, IOException, SAXException, ParserConfigurationException, TransformerConfigurationException, TransformerException{
        ...
        FileIO.writeDocumentToLocalFile("Y:\\thomas\\OS2FLK\\Siglen.xml", out);
    }
