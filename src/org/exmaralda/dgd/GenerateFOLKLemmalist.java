 ...
 * @author Schmidt
 */
public class GenerateFOLKLemmalist {

    File transcriptDirectory;
    HashtableTokenList tokenlist = new HashtableTokenList();
            
    public GenerateFOLKLemmalist(String transcriptPath) {
    ...
    void makeWordlist() throws JDOMException, IOException{
        ...
        tokenlist.readWordsFromFolkerFiles(transcriptFiles, "//w/@lemma");        
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            GenerateFOLKLemmalist gfw = new GenerateFOLKLemmalist(args[0]);
            gfw.makeWordlist();
            gfw.writeWordList(args[1]);
        } catch (JDOMException ex) {
            Logger.getLogger(GenerateFOLKLemmalist.class.getName()).log(Level.SEVERE, null, ex);
