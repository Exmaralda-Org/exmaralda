...
public class TranscriberBuilder {
    ...
    Hashtable<String,File> communicationsWithTranscriberFiles = new Hashtable<String, File>();
    ...
    public TranscriberBuilder(File resultFile, Vector<File> transcriberFiles, String directory, boolean separateDirectory, boolean writeBasic) throws IOException {
        this.resultFile = resultFile;
        this.transcriberFiles = transcriberFiles;
    ...
    public void doBuild() throws JDOMException, IOException, SAXException, ParserConfigurationException, TransformerConfigurationException, TransformerException, JexmaraldaException, URISyntaxException{
        ...
        for (File transcriberFile : transcriberFiles){
            ...
            // read the transcriber file as a Basic Transcription
