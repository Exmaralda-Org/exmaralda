...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <xsl:param name="TIER-DEFINITIONS">
            <tiers>
                  ...
                  <!--<tier name="st" type="a" cleanup="brackets" itemtype="lit" lang="dlg-x-source" template="tier-sent"/>-->
                  ...
                  <!--<tier name="hn" type="a" itemtype="hn" lang="en" sep="-" template="tier-morph"/>--> <!-- hn tier is no longer used as of Dec 2018 -->
                  ...
                  <tier name="BOR" type="a" cleanup="brackets, gloss" itemtype="gls" lang="de-x-source" sep="" template="tier-morph"/>
                  ...
                  <!--<tier name="ltg" template="tier-sent" itemtype="lit" lang="de-x-source" cleanup="brackets"></tier> --> <!-- This is for Donner's texts only -->
