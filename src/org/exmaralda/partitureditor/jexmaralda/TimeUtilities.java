...
public class TimeUtilities {
    ...
    static String makeTimeString (double time, String format){
        ...
        if (miliseconds<100) {milisecondsString = "0" + milisecondsString;}
        if (miliseconds<10) {milisecondsString = "0" + milisecondsString;}
        if (miliseconds<1) {milisecondsString = "0" + milisecondsString;}        
