...
public class EditPreferencesDialog extends javax.swing.JDialog {
    ...
    public EditPreferencesDialog(java.awt.Frame parent, boolean modal, org.exmaralda.common.ExmaraldaApplication app) {
        ...
        /** change 04-12-2019 issue #199 **/
        // all of these players will not be supported any longer */
        elanQuicktimeRadioButton.setVisible(false);
        jmfPlayerRadioButton.setVisible(false);
        cocoaQuicktimePlayerRadioButton.setVisible(false);
        elanDSPlayerRadioButton.setVisible(false);
        
        // these players are platform specific
        jdsPlayerRadioButton.setVisible(os.startsWith("win"));
        mmfPlayerRadioButton.setVisible(os.startsWith("win"));
        avfPlayerRadioButton.setVisible(os.startsWith("mac"));
    ...
    private void changeGenericButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeGenericButtonActionPerformed
        AbstractXMLOpenDialog dialog = new AbstractXMLOpenDialog(genericTextField.getText());
        dialog.setFileFilter(new ParameterFileFilter("xml", "Finite State Machine (*.xml)"));
        if (dialog.showDialog(this,"Choose")==javax.swing.JFileChooser.APPROVE_OPTION){
    ...
    private void changecGATMinimalButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changecGATMinimalButtonActionPerformed
