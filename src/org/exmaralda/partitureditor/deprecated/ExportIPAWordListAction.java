 ...
 * @author thomas
 */
public class ExportIPAWordListAction extends AbstractFSMSegmentationAction {
    
    /** Creates a new instance of ExportDIDAHTMLWordListAction */
    public ExportIPAWordListAction(PartitureTableWithActions t, javax.swing.ImageIcon icon) {
        super("Word list (HTML)", icon, t); 
    }
    
    public void actionPerformed(java.awt.event.ActionEvent actionEvent) {
        System.out.println("exportIPAWordListAction!");
        table.commitEdit(true);
        exportIPAWordList();        
    }
    
    private void exportIPAWordList(){
         ...
         try{
             ...
             SegmentList words = st.makeSegmentList("IPA:w");
