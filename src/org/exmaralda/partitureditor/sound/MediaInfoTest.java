...
public class MediaInfoTest {
    ...
    public static void main(String[] args) {
        ...
        /*try {
            ...
            System.out.println(" " + mediaDescriptor.GENERIC_AUDIO_TYPE);
            System.out.println(" " + mediaDescriptor.mediaURL);
            System.out.println(" " + mediaDescriptor.mimeType);
            System.out.println(" " + mediaDescriptor.toString());
