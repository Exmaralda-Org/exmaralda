...
public class AVFPlayer extends AbstractPlayer implements ControllerListener {
    ...
    mpi.eudico.client.annotator.player.JAVFELANMediaPlayer wrappedPlayer;
    //Thread playThread;
    ...
    public void setSoundFile(String pathToSoundFile) throws IOException {
        System.out.println("This is the AVFPlayer setting media file to " + pathToSoundFile);
        ...
        try {
            ...
            wrappedPlayer = new mpi.eudico.client.annotator.player.JAVFELANMediaPlayer(mediaDescriptor);
