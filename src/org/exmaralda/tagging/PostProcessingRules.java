...
public class PostProcessingRules {
    ...
    public int applyISOTEI(Document taggedDocument, String language) throws JDOMException{
        XPath xpath = XPath.newInstance("//tei:w[ancestor-or-self::*[@xml:lang][1]/@xml:lang='" + language + "']");
        xpath.addNamespace("tei", "http://www.tei-c.org/ns/1.0");        
        List l = xpath.selectNodes(taggedDocument);
        int count = 0;
        for (Object o : l){
