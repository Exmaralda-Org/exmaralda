 ...
 * 
 */
public class KeyRenameAction extends ComaAction {
	Style style;
	StyledDocument doc;
	JTextPane textPane;
	public KeyRenameAction(Coma c, javax.swing.ImageIcon icon) {
		super(Ui.getText("cmd.KeyRenameAction"), icon, c);
		this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(
				KeyEvent.VK_K, Toolkit.getDefaultToolkit()
						.getMenuShortcutKeyMask()));
		this.putValue(Action.SHORT_DESCRIPTION, Ui
				.getText("cmd.KeyRenameAction"));
	}
	public KeyRenameAction(Coma c) {
		this(c, null);
	}
