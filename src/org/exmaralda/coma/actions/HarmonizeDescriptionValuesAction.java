 ...
 * 
 */
public class HarmonizeDescriptionValuesAction extends ComaAction {
	Style style;
	StyledDocument doc;
	JTextPane textPane;
	public HarmonizeDescriptionValuesAction(Coma c, javax.swing.ImageIcon icon) {
		super(Ui.getText("cmd.HarmonizeValuesAction"), icon, c);
		this.putValue(Action.SHORT_DESCRIPTION, Ui
				.getText("cmd.HarmonizeValuesAction"));
	}
	public HarmonizeDescriptionValuesAction(Coma c) {
		this(c, null);
	}
