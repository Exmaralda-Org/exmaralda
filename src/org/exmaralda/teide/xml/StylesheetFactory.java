...
public class StylesheetFactory {
	...
	public String applyInternalStylesheetToString(
			String pathToInternalStyleSheet, String sourceString)
			throws SAXException, ParserConfigurationException, IOException,
			TransformerConfigurationException, TransformerException {

		// set up the transformer
		TransformerFactory tFactory = TransformerFactory.newInstance();
		java.io.InputStream is2 = getClass().getResourceAsStream(
				pathToInternalStyleSheet);
		if (is2 == null) {
			throw new IOException("Stylesheet not found!");
		}
		javax.xml.transform.stream.StreamSource styleSource = new javax.xml.transform.stream.StreamSource(
				is2);
		...
		javax.xml.transform.stream.StreamResult resultStream = new StreamResult(
				sw2);
	...
	public String applyInternalStylesheetToExternalXMLFile(
			String pathToInternalStyleSheet, String pathToExternalXMLFile)
			throws SAXException, ParserConfigurationException, IOException,
			TransformerConfigurationException, TransformerException {
		...
		javax.xml.transform.stream.StreamResult inputStream = new StreamResult(
				sw);
	...
	public String applyExternalStylesheetToString(
			String pathToExternalStyleSheet, String sourceString)
			throws SAXException, ParserConfigurationException, IOException,
			TransformerConfigurationException, TransformerException {

		// set up the transformer
		TransformerFactory tFactory = TransformerFactory.newInstance();
		java.io.FileInputStream is2 = new FileInputStream(
				pathToExternalStyleSheet);
		if (is2 == null) {
			throw new IOException("Stylesheet not found!");
		}
		javax.xml.transform.stream.StreamSource styleSource = new javax.xml.transform.stream.StreamSource(
	...
	public String applyExternalStylesheetToExternalXMLFile(
			String pathToExternalStyleSheet, String pathToExternalXMLFile)
			throws SAXException, ParserConfigurationException, IOException,
			TransformerConfigurationException, TransformerException,
