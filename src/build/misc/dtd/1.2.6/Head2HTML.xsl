...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				<xsl:apply-templates select="list-transcription | basic-transcription | segmented-transcription"/>
			</body>
		</html>
	</xsl:template>
	<xsl:template match="list-transcription | basic-transcription | segmented-transcription">
