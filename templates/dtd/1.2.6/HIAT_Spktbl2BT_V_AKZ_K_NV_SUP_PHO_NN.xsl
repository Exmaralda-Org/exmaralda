	...
	<xsl:template name="MakeTiers">
		<body>
			...
			<xsl:for-each select="/speakertable/speaker">
				...
				<!-- Spur für phonetische Transkription -->
				<xsl:element name="tier">
					<xsl:attribute name="id"><xsl:text>TIE_PHO_</xsl:text><xsl:value-of select="@id"></xsl:value-of></xsl:attribute>
					<xsl:attribute name="speaker"><xsl:value-of select="@id"></xsl:value-of></xsl:attribute>
					<xsl:attribute name="type">a</xsl:attribute>
					<xsl:attribute name="category">pho</xsl:attribute>
					<xsl:attribute name="display-name">
				...
				<!-- Non-verbale Spur -->
				<xsl:element name="tier">
					<xsl:attribute name="id"><xsl:text>TIE_NV_</xsl:text><xsl:value-of select="@id"></xsl:value-of></xsl:attribute>
					<xsl:attribute name="speaker"><xsl:value-of select="@id"></xsl:value-of></xsl:attribute>
					<xsl:attribute name="type">d</xsl:attribute>
					<xsl:attribute name="category">np</xsl:attribute>
					<xsl:attribute name="display-name">
						<xsl:value-of select="abbreviation"/>
